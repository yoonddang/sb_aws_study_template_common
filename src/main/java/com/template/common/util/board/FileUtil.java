package com.template.common.util.board;
...
public class FileUtil {
    ...
    public List<FileVO> saveAllFiles(List<MultipartFile> upfiles) {
        ...
        for (MultipartFile uploadfile : upfiles ) {
            ...
            filedo.setFile_name(uploadfile.getOriginalFilename());
            filedo.setReal_name(newName);
            filedo.setFile_size(uploadfile.getSize());
            filelist.add(filedo);
        }
        return filelist;
    }    
